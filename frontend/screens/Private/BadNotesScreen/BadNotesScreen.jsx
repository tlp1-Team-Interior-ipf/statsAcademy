        ...
        <View style={{ backgroundColor: BackgroundTheme, alignItems: 'center', height: '100%' }}>
            ...
            <ScrollView>
                <View style={{ flexDirection: 'row', gap: 20, marginVertical: 10 }}>
                    <ProfileCard NameLibrariIcon={'MaterialCommunityIcons'} nameIcon={'notebook-minus'} sizeIcon={30} textCardProfile={t('Peores-notas-card')} sizeText={30} sizePaddingText={10} showCounter={true}/>
                    <ProfileCard NameLibrariIcon={'MaterialCommunityIcons'} nameIcon={'notebook-minus'} sizeIcon={30} textCardProfile={t('Peores-notas-card')} sizeText={30} sizePaddingText={10} showCounter={true}/>
                </View>
